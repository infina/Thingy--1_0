                        ...
                        for rawl in temp:
                                ...
                                #We've received a message in a channel or pm. (PRIVMSG is for channels as well.)
                                        ...
                                        if (msg.startswith("VERSION")):
                                                ...
                                                self.send("PRIVMSG" + sender + ": REPLY" + VERSION)
                                ...
                                #elif line[4] == "VERSION":
                                        #
                                        #self.send("REPLY" + sender + VERSION)
                                        #
...
class CTCP_Version:
        '''Replies to CTCP Version requests with Thingy Version, which is stored in another file'''
